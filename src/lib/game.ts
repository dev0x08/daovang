...
export const DECK_COUNTS:Record<PathKind|ActionKind,number>={
 h:18,v:6,ne:6,nw:6,se:6,sw:6,tUp:4,tDown:4,tLeft:4,tRight:4,cross:5,collapse:6,
 delete:8,shield:5,rotate:0,scout:4,block:4,revive:5,swap:0
};
