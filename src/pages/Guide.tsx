...
export default function Guide(){return <section className="guide-page guide-full ui-v2-page app-page">
 ...
 <section className="guide-section"><header><GameEmblem icon={Trophy} size="sm"/><div><span>04</span><h2>KẾT THÚC TRẬN VÀ EXP</h2></div></header><div className="guide-two-col"><article><h3>THỢ ĐÀO THẮNG</h3><p>Một tuyến đường hợp lệ nối từ cửa hầm tới rương vàng thật.</p></article><article><h3>SÓI THẮNG</h3><p>Thợ đào không thể tìm được vàng trước khi tài nguyên cần thiết đã cạn.</p></article></div><div className="reward-row"><span><b>THẮNG</b> 48–96 EXP · 65–135 vàng</span><span><b>THUA</b> 20–52 EXP · 24–68 vàng</span></div></section>
 <section className="guide-section guide-rank-section"><header><GameEmblem icon={Trophy} size="sm"/><div><span>05</span><h2>XẾP HẠNG VÀ SỐ SAO</h2></div></header><div className="rank-guide-grid"><article><b>8 BẬC</b><p>Sắt → Đồng → Bạc → Vàng → Bạch Kim → Kim Cương → Cao Thủ → Thách Đấu.</p></article><article><b>5 MỐC SAO</b><p>Mỗi đoàn rộng 100 điểm ngầm. Cứ vượt thêm 20 điểm sẽ tăng 1 sao; đủ mốc tiếp theo sẽ lên đoàn.</p></article><article><b>THẮNG / THUA</b><p>Kết quả mỗi trận đổi khoảng ±16 điểm khi hai bên ngang sức. Đối thủ mạnh hơn giúp thắng được nhiều và thua mất ít hơn.</p></article><article><b>CHUỖI THẮNG</b><p>Từ trận thắng liên tiếp thứ hai, thưởng thêm 2 điểm mỗi trận, tối đa +12. Trận có AI không tính sao.</p></article></div></section>
 </section>}
